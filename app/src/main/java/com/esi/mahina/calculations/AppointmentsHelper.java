...
import com.esi.mahina.dates.AppointmentDates;
...
public class AppointmentsHelper {
    ...
    public static BiFunction<LocalDate, Integer, String> getVisit2To8DateRange = (lmp, weeeks)->{
        ...
        switch (weeeks){
            case 20: AppointmentDates.setVisit2Date(beginDate); break;
            case 30: AppointmentDates.setVisit3Date(beginDate); break;
            case 34: AppointmentDates.setVisit4Date(beginDate); break;
            case 36: AppointmentDates.setVisit5Date(beginDate); break;
            case 38: AppointmentDates.setVisit6Date(beginDate); break;
            case 40: AppointmentDates.setVisit7Date(beginDate); break;
            default: break;
        }
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd-MMM-yyyy");
        return  beginDate.format(formatter) + " to "  + endDate.format(formatter);
